...
using ScriptableArchitecture.EditorScript;
using System;
using System.Linq;
...
{
    [CustomEditor(typeof(KartStatsVariable<>), true)]
    [CanEditMultipleObjects]
    public class KartStatsEditor : Editor
    {
        private KartStatsVariable _target;
        ...
        {
            _target = target as KartStatsVariable;
