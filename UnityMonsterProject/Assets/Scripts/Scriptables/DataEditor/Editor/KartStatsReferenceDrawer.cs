...
{
    [CustomPropertyDrawer(typeof(KartStatsReference<,>), true)]
    public class KartStatsReferenceDrawer : PropertyDrawer
    {
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            if (isVariableProperty.boolValue)
                ...
                return 15;// EditorGUI.GetPropertyHeight(property.FindPropertyRelative("_constant"), true);
        }
