...
namespace ScriptableArchitecture.DataEditor
{
    [CustomPropertyDrawer(typeof(KartStatsVariable<>), true)]
    public class KartStatsVariableDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (property.boxedValue != null)
            {
                ...
                if (_foldoutOpen && property.objectReferenceValue != null)
                {
                    ...
                    var valueVariable = property.objectReferenceValue as KartStatsVariable;
            ...
            else
            {
                ...
                if (GUI.Button(buttonRect, "New", EditorStyles.miniButton))
                {
                    ...
                    KartStatsVariable newVariable = ScriptableObject.CreateInstance(newType) as KartStatsVariable;
