...
{
    [SerializeField] internal UniversalRendererData RenderData;
...
[DisallowMultipleRendererFeature("Custom Screen Space Ambient Occlusion")]
[Tooltip("The Ambient Occlusion effect darkens creases, holes, intersections and surfaces that are close to each other.")]
public class CustomAmbientOcclusion : ScriptableRendererFeature
{
    // Serialized Fields
    ...
    private CustomAmbientOcclusionPass m_SSAOPass = null;
    ...
    public override void Create()
    {
        ...
        // Create the pass...
        if (m_SSAOPass == null)
            m_SSAOPass = new CustomAmbientOcclusionPass();
    ...
    // The SSAO Pass
    private class CustomAmbientOcclusionPass : ScriptableRenderPass
    {
        ...
        private bool isRendererDeferred => m_Renderer != null && m_CurrentSettings?.RenderData != null && m_Renderer is UniversalRenderer && m_CurrentSettings.RenderData.renderingMode == RenderingMode.Deferred;
        ...
        internal CustomAmbientOcclusionPass()
        {
            ...
            switch (m_CurrentSettings.AOMethod)
            {
                case ScreenSpaceAmbientOcclusionSettings.AOMethodOptions.BlueNoise:
                    ...
                    m_Material.SetVector(s_SSAOBlueNoiseParamsID, new Vector4(
                        cameraTargetDescriptor.width / (float)noiseTexture.width,    // X Scale
                        cameraTargetDescriptor.height / (float)noiseTexture.height,  // Y Scale
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            using (new ProfilingScope(cmd, new ProfilingSampler("Custom SSAO")))
            {
